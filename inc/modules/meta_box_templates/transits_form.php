<!-- Post type key value -->
<?php
    wp_nonce_field( 'ais_transit_submit_data', 'ais_transit_submit_field' );

    $tr     = $this->meta_data['ais_transit_recommendation'];
?>
    ...
    <div class="select-inline-area">
        <div class="select-inline-container">
            ...
            <div class="select-inline-content">
                <?php ais_select_options_bool( 'ais_transit_recommendation', $tr, null ); ?>
            </div>
        </div>
